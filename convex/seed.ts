...
export const seed = internalMutation({
  ...
  handler: async (ctx) => {
    ...
    // 2. Services Data — SOLO 8 servicios (4 salud + 4 notariales)
      ...
      // ===================== SALUD =====================
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            multiple: true,
            description: "Envíenos una foto, imagen o PDF de la orden médica, MIPRES o autorización si es el caso.",
      ...
      },
      {
        ...
        fields: [
          ...
          },
          {
            ...
            required: true,
            multiple: true,
            description: "Envíenos una foto, imagen o PDF de la orden médica, resumen de historia clínica y MIPRES si es el caso.",
            settings: { maxFiles: 5, acceptedMimeTypes: ["application/pdf", "image/jpeg", "image/png", "image/jpg", "image/webp"] },
          },
        ],
      },
        ...
        fields: [
          {
            ...
            required: true,
            multiple: true,
            description: "Envíenos una foto, imagen o PDF de la orden médica y autorización.",
            settings: { maxFiles: 5, acceptedMimeTypes: ["application/pdf", "image/jpeg", "image/png", "image/jpg", "image/webp"] },
          },
          {
            ...
            required: false,
            multiple: true,
            description: "Envíenos una foto, imagen o PDF del resumen de historia clínica. Si no la tienes, no te preocupes.",
