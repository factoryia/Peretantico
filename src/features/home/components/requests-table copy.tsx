...
export function RequestsTable({
  ...
  const { data: completeRequestsData } = useCompleteRequests();

  console.log("REQUESTS DATA:", completeRequestsData);
          ...
          <TableBody>
            {displayRequests.map((displayRequest) => {
              const request = data.data.find(
                (r: Request) => r.id === displayRequest.id
              );
