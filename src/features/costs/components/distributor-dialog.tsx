...
import { PROFILE_QUERY_KEY } from "@/features/client/constants/index";
...
export function DistributorDialog({
  ...
  const dialogTitle = isEditing ? "Editar cliente" : "Nuevo cliente";
  ...
  const handleSubmit = async (values: Record<string, unknown>) => {
    try {
      // TODO: Implement customer update/create logic
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-end space-y-2 sm:space-y-0 sm:space-x-2 pt-4">
              ...
              >
                ...
                {distributor ? "Actualizar" : "Crear"} Cliente
              </Button>
            </div>
          </form>
        </Form>
